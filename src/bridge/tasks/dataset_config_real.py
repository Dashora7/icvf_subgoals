...
def get_single_task(dir):
    train_dataset_single_task = [dir+'/robonetv2/toykitchen_numpy_shifted/bridge_data_numpy_shifted_split_uint8_5-26/toykitchen1/put_broccoli_in_pot_cardboardfence/train/out.npy']
    eval_dataset_single_task = [dir+'/robonetv2/toykitchen_numpy_shifted/bridge_data_numpy_shifted_split_uint8_5-26/toykitchen1/put_broccoli_in_pot_cardboardfence/val/out.npy']
    return train_dataset_single_task, eval_dataset_single_task

def get_single_task_openmicro(dir):
    train_dataset_single_task_openmicro = [dir+'/robonetv2/toykitchen_numpy_shifted/bridge_data_numpy_shifted_split_uint8_5-26/toykitchen5/open_microwave/train/out.npy']
    eval_dataset_single_task_openmicro = [dir+'/robonetv2/toykitchen_numpy_shifted/bridge_data_numpy_shifted_split_uint8_5-26/toykitchen5/open_microwave/val/out.npy']
    return train_dataset_single_task_openmicro, eval_dataset_single_task_openmicro
...
def get_11tasks(dir):
    ...
    train_dataset_11_task = [dir+f'/robonetv2/toykitchen_numpy_shifted/bridge_data_numpy_shifted_split_uint8_5-26/toykitchen1/{task}/train/out.npy' for task in train_tasks]
    ...
    eval_dataset_11_task = [dir+f'/robonetv2/toykitchen_numpy_shifted/bridge_data_numpy_shifted_split_uint8_5-26/toykitchen1/{task}/val/out.npy' for task in val_tasks]
    return train_dataset_11_task, eval_dataset_11_task
...
def openclose(dir):
    train_dataset_openclose = [dir+f'robonetv2/toykitchen_numpy_shifted/bridge_data_numpy_shifted_split_uint8_5-26/toykitchen5/{task}/train/out.npy' for task in train_tasks_tk5]
    train_dataset_openclose.extend([dir+f'robonetv2/toykitchen_numpy_shifted/bridge_data_numpy_shifted_split_uint8_5-26/toykitchen1/{task}/train/out.npy' for task in train_tasks_tk6])
    train_dataset_openclose.extend([dir+f'robonetv2/toykitchen_numpy_shifted/bridge_data_numpy_shifted_split_uint8_5-26/toykitchen6/{task}/train/out.npy' for task in train_tasks_tk6])
    eval_dataset_openclose = [dir+f'robonetv2/toykitchen_numpy_shifted/bridge_data_numpy_shifted_split_uint8_5-26/toykitchen5/{task}/val/out.npy' for task in train_tasks_tk5]
    eval_dataset_openclose.extend([dir+f'robonetv2/toykitchen_numpy_shifted/bridge_data_numpy_shifted_split_uint8_5-26/toykitchen1/{task}/val/out.npy' for task in train_tasks_tk6])
    eval_dataset_openclose.extend([dir+f'robonetv2/toykitchen_numpy_shifted/bridge_data_numpy_shifted_split_uint8_5-26/toykitchen6/{task}/val/out.npy' for task in train_tasks_tk6])
    return train_dataset_openclose, eval_dataset_openclose
